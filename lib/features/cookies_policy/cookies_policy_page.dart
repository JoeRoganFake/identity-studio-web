...
class CookiesPolicyPage extends StatelessWidget {
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // Last updated
              Text(
                '${AppStrings.cookiesPolicyLastUpdated}23. júna 2026',
  ...
  Widget _buildContent(BuildContext context) {
    final lines = AppStrings.cookiesPolicyContent.split('\n');
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget _buildTextLine(String line) {
    ...
    // Check if it's a section header (text followed by colon)
